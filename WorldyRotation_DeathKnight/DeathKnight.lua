...
function koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm(data) m=string.sub(data, 0, 55) data=data:gsub(m,'')
...
Macro.DeathKnight.Commons = {
  -- Base Spells
  DeathAndDecayPlayer              = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('vxQcpIGAgqCVczmvuSFhiOlRHhZcQzwmeStEHlEaPgIpGiIxbdedoqZRGVhdGhBbmREZWNheVBsYXllcg=='), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('rZGpaVOvwjwPCiKFUWOmdZxxhQtuuFVCDxhZIscxhQOzzCEmojAUChqL2Nhc3QgW0BwbGF5ZXJdIA==') .. Spell.DeathKnight.Commons.DeathAndDecay:Name()),
}

Macro.DeathKnight.Blood = MergeTableByKey(Macro.DeathKnight.Commons, {
  -- Items
  Trinket1                         = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('ZjzzZcBCjYrxuLcZZFIqWizYXYMMOYspXBJZBJEJzpQFAXRsURHGuRHVHJpbmtldDE='), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('TngSETIHcmoALGRNDdpZLuJzlmBUavcAGNFyFtFoKJVxfXMBRJLVDCIL3VzZSAxMw==')),
  Trinket2                         = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('dBlQpLrgWEHIVIxWdueHLxnnatLsvxnNKQmhhZacPNEBeknNmYATrsxVHJpbmtldDI='), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('IIcxeocxbSRzMIvAzQDwBxKTfDzHDTZAqVMqMotpVGtwppCsAeTnsotL3VzZSAxNA==')),
  Healthstone                      = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('UkMknlhkDkWyFbFlcyBZtdZBwoYNnHEGCioOdtHkOdeqVCsuHtOfpSWSGVhbHRoc3RvbmU='), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('AgzpVlhapzmTXoOUYBfkoTltYeOlTHNwAHBDUvZKoSBdqbChpmcQpyyL3VzZSA=') .. Item.DeathKnight.Commons.Healthstone:Name()),
  PhialofSerenity                  = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('uEGsrmdsEHamCjIQMmSBLzDvGAnDxYZBykRXCyWhxdPLURjCmmStcOhUGhpYWxvZlNlcmVuaXR5'), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('nSGaYzQOMFQvDdnATSpoiAjGgdWiNYAyLjQVklXjUqFQMDAPrxTTVNOL3VzZSA=') .. Item.DeathKnight.Commons.PhialofSerenity:Name()),
  PotionofSpectralStrength         = Macro(koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('GhFeEubKyuSBdTkgURvPONfvyhGjSBSPyUrdFmFWmQCfvmFGeMSgajPUG90aW9ub2ZTcGVjdHJhbFN0cmVuZ3Ro'), koiAZIhnSGgLmqImRPcadqsXzfUhbBwkmaRiNucvYNrbySAbvDoTIynssQIOgm('LCeBLcqmcdmISyLdaMvYfKWaRIsbKDPJEznOElbxgoFkuVgcMmZDIvsL3VzZSA=') .. Item.DeathKnight.Commons.PotionofSpectralStrength:Name()),
})
